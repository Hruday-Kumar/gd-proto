// Minimal RIFF/WAVE PCM reader -- ported verbatim from the validated
// Phase 0a/P2 spike (spike/src/wav.js). Enough to load the speech clips
// the regression bots "speak".
